...
class PipelineTests(unittest.TestCase):
    ...
    def test_august_run_is_same_site(self):
        emergencies = [r for r in self.groups if r["category"] == "emergency" and "SITE_B" in r["evidence_sites"].split(";")]
    ...
    def test_planned_nov2_explicit_window_not_silently_extended(self):
        r = next(x for x in self.groups if x["group_id"] == "G20251102")
    ...
    def test_nov28_cancellation_is_not_asserted_for_both_sites(self):
        r = next(x for x in self.groups if x["group_id"] == "G20251128")
